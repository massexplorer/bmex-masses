...
def quantity_options(dataset, single=False):
    ...
    if dataset in ['ME2', 'MEdelta', 'PC1', 'NL3S']:
        ...
        [
            ...
            {"label": "Beta Q-value", "value": "BetaQ", "title": "Q-value for beta decay reactions"},
            {"label": "Arbitrary Q-value", "value": "ArbitraryQ", "title": "Q-value for user-defined reactions"},
